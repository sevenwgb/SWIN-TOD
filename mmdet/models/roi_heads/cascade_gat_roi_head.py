...
class CascadeGatRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeGatRoIHead, self).__init__(
    ...
    def _bbox_forward_gcn_train_v2(self, stage, x, rois, bbox_targets):
        ...
        model = GAT(num_node_features=256,num_hide_features=256,num_classes=9,num_heads=1).to(bbox_feats.device)
    ...
    def aug_test(self, features, proposal_list, img_metas, rescale=False):
        ...
        for x, img_meta in zip(features, img_metas):
            ...
            for i in range(self.num_stages):
                ...
                bbox_results['cls_score'][fg_ind] = 0.9*bbox_results['cls_score'][fg_ind]  + 0.1*bbox_results['cls_score_gcn']
